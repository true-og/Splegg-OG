        ...
        if (this.lobbycount >= 1) {
            ...
            if (this.lobbycount % 25 == 0) {
                ...
                SpleggOG.getPlugin()
                        ...
                        .bc(
                                SpleggOG.getPlugin()
                                        .getConfig()
                                        .getString("Messages.LobbyTimer")
                                        .replaceAll("%timer%", String.valueOf(this.lobbycount)),
                                this.game);
            }
            ...
            if (this.lobbycount <= 10 && this.lobbycount >= 1) {
                ...
                while (playersInGameIterator.hasNext()) {
                    ...
                    sp = (SpleggPlayer) playersInGameIterator.next();
                    sp.getPlayer()
                            .playSound(sp.getPlayer().getLocation(), Sound.BLOCK_STONE_BUTTON_CLICK_ON, 1.0F, 1.0F);
                }
            }
            ...
            SpleggOG.getPlugin()
                    .chat
                    .bc(SpleggOG.getPlugin().getConfig().getString("Messages.NoEnoughPlayers"), this.game);
            Bukkit.getScheduler().cancelTask(this.game.getCounterID());
