...
public class SpleggOG extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (this.getServer().getPluginManager().getPlugin("WorldEdit") == null) {
            ...
            String noWorldEditError =
                    "\"ERROR: WorldEdit not found! Without WorldEdit, Splegg-OG will not function. Please download it from http://dev.bukkit.org/bukkit-plugins/worldedit\"";
