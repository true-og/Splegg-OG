...
public class Utils {
    ...
    public static Inventory getShopInventory() {
        ...
        TextComponent shopTitleComponent =
                legacySerializerAnyCase(SpleggOG.getPlugin().getConfig().getString("GUI.Shop.Title"));
        ...
        String goldShovelNameComponent = LegacyComponentSerializer.legacyAmpersand()
                .serialize(legacySerializerAnyCase(
                        SpleggOG.getPlugin().getConfig().getString("GUI.Shop.GoldShovel.Name")));
        String goldShovelDescriptionComponent = LegacyComponentSerializer.legacyAmpersand()
                .serialize(legacySerializerAnyCase(SpleggOG.getPlugin()
                        .getConfig()
                        .getString("GUI.Shop.GoldShovel.Description")
                        .replaceAll(
                                "%price%",
                                "&B"
                                        + String.valueOf(SpleggOG.getPlugin()
                                                .getConfig()
                                                .getInt("GUI.Shop.GoldShovel.Price")))));

        String diamondShovelNameComponent = LegacyComponentSerializer.legacyAmpersand()
                .serialize(legacySerializerAnyCase(
                        SpleggOG.getPlugin().getConfig().getString("GUI.Shop.DiamondShovel.Name")));
        String diamondShovelDescriptionComponent = LegacyComponentSerializer.legacyAmpersand()
                .serialize(legacySerializerAnyCase(SpleggOG.getPlugin()
                        .getConfig()
                        .getString("GUI.Shop.DiamondShovel.Description")
                        .replaceAll(
                                "%price%",
                                "&B"
                                        + String.valueOf(SpleggOG.getPlugin()
                                                .getConfig()
                                                .getInt("GUI.Shop.DiamondShovel.Price")))));
